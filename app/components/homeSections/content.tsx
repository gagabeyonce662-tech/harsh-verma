...
import { CONTACT, heroSlides, serviceAreas, services, testimonials } from "../homeLanding.data";
            ...
            <ul className="why-list">
              <li>
                ...
                <div className="why-list-text">
                  ...
                  <span>
                    Deep expertise in the brands fleets rely on most across Ontario.
                  </span>
                </div>
              </li>
              <li>
                ...
                <div className="why-list-text">
                  ...
                  <span>
                    We know downtime costs money. We work efficiently so you can get
                    back on the road.
                  </span>
                </div>
              </li>
              <li>
                ...
                <div className="why-list-text">
                  ...
                  <span>
                    No hidden costs, no dealer markups. You always know exactly what
                    you&apos;re paying for.
                  </span>
                </div>
              </li>
              <li>
                ...
                <div className="why-list-text">
                  ...
                  <span>
                    Harsh Verma personally oversees every repair - your truck is never
                    just a number.
                  </span>
                </div>
              </li>
              <li>
                ...
                <div className="why-list-text">
                  ...
                  <span>
                    From single rigs to large fleets, we tailor service packages to
                    fit your operation.
                  </span>
                </div>
              </li>
